 ...
 * @flow
 *
 * This is an autogenerated libdef for: electron-v6.0.9 renderer process
 */
...
declare module 'electron' {
    ...
    remote: {
      ...
      app: {
        ...
        on: ((
          ...
          ((
            eventName: 'renderer-process-crashed',
            callback: (
              event: Event,
              webContents: WebContents,
              killed: boolean
      ...
      inAppPurchase: {
        ...
        getProducts: (productIDs: Array<string>) => Promise<any>,
      ...
      powerMonitor: {
        ...
        querySystemIdleTime: (callback: Function) => void,
        getSystemIdleState: (
          idleThreshold: number
      ...
      systemPreferences: {
        ...
        promptTouchID: (reason: string) => Promise<any>,
  ...
  declare type ProcessMemoryInfo = {
    residentSet: number,
    private: number,
    shared: number
  };
  ...
  declare class webviewTag extends HTMLElement {
    ...
    capturePage: (rect?: ?Rectangle) => Promise<any>;
    send: (channel: string, ...args: Array<any>) => void;
  ...
  declare class Session {
    ...
    resolveProxy: (url: URL) => Promise<any>;
  ...
  declare class Tray {
    ...
    on: ((
      ...
      ((
        ...
        callback: (event: KeyboardEvent, bounds: Rectangle) => void
      ) => void) &
      ((
      ...
      ((
        ...
        callback: (event: KeyboardEvent, position: Point) => void
      ) => void) &
      ((
